...
<title>PoliceUpdationSuccess</title>
</head>
<body background="pics/pic5.jpg">

<%

Object obj=session.getAttribute("police_bean_new");
...
<h1 align="center">Police Officer, <%= police_bean.getPolice_name()%>'s particulars is updated successfully...</h1>
...
<h1 align="center">Police record updation failed...</h1>
