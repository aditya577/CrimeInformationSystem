...
<form action="PasswordChangeByPoliceSrv" method="post">

<input type="hidden" name="police_username" value="<%= police_bean.getPolice_username()%>">
<input type="hidden" name="police_password" value="<%= police_bean.getPolice_password()%>">

<input type="password" name="old_password" placeholder="Enter Old Password" required><br><br>
<input type="password" name="new_password1" placeholder="Enter New Password" required><br><br>
<input type="password" name="new_password2" placeholder="Confirm New Password" required><br><br>
