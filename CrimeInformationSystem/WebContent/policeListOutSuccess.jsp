...
<tr><th>Unique ID</th><th>Name</th><th>Username</th><th>Police Station</th><th>Mobile</<th><th>Assigned Case Id</th></tr>
...
<td><%= police_bean.getPolice_username() %></td>
<td><%= police_bean.getPolice_station() %></td>
<td><%= police_bean.getPolice_mobile() %></td>
<td><%= police_bean.getComplaint_id() %></td>


<%

session.setAttribute("police_bean", police_bean);

%>

<td><a href="updatePoliceList.jsp">Update/Assign Case</a></td>
