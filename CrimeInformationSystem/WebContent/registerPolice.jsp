...
<title>PoliceRegistration</title>
</head>
...
if(obj != null){
	...
	ArrayList<ComplaintBean> complaint_list=(ArrayList<ComplaintBean>)obj;
...
<h1 align="center">Police Officer Registration</h1><br>

<div style="text-align:center">

<form action="PoliceRegisterSrv" method="post">

Name:<input type="text" name="police_name" placeholder="Ram Singh" required><br><br>
Police Station:<select name="police_station" required><br><br>

<option value="Ranichak PS">Ranichak PS</option>
<option value="Khudiramnagar PS">Khudiramnagar PS</option>
<option value="Durgachak PS">Durgachak PS</option>


</select><br><br>


Police Username:<input type="text" name="police_username" placeholder="ram@gmail.com" required><br><br>

Mobile:<input type="number" name="police_mobile" placeholder="9876543210" required><br><br>

Initial Password:<input type="text" name="police_password" placeholder="***********" required><br><br>


First Case Id:<select name="complaint_id" required>
<%
